...
from utils.medication import generate_medications
...
def lambda_handler(event, context):
    try:
        ...
        upload_to_s3(s3, medications_df,DST_BUCKET, RAW_FOLDER, 'medications')

        procedure_df = generate_procedures(5000)
        upload_to_s3(s3, procedure_df,DST_BUCKET, RAW_FOLDER, "procedures")
