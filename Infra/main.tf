...
module "airbyte" {
  ...
  db_source_name = local.db_source_name
  ...
  s3bucket = module.s3bucket.s3_bucket_redshift_integration_bucket
  ...
  airbyte_s3_bucket_name = module.s3bucket.airbyte_s3_bucket_output
